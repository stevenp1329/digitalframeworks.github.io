...
Nine different requesters declared associations with the Chicago Tribune, more than any other publication. At first glance, it seems the Chicago Sun-Times isn't too far behind, with seven unique requesters; a closer read, however, reveals that four of the seven requesters are "Tim Novak," "Chris Fusco," "Tim Novak & Chris Fusco" and "Chris Fusco & Tim Novak." So that leaves only five unique individuals on the Sun-Times list of people filing requests, demonstrating the importance of remembering that all data is dirty data.

Additionally, it's important that I emphasize that this is an extremely small sample of FOIA requests. Other reporters and interested parties can submit requests to the Chicago Police Department or any of several related public agencies. Nonetheless, these data are always interesting to review — almost as interesting as the subject matter of the FOIA requests themselves.
